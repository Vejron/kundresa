<template>
  <header class="relative max-w-7xl mx-auto">
    <div class="px-4 lg:px-8 mb-20">
      <h1
        class="text-4xl sm:text-6xl lg:text-7xl leading-none font-extrabold tracking-tight text-gray-900 mb-8 sm:mb-10"
      >
        {{ blok.title }}
      </h1>
      <p
      ...
      >
        ...
        <span class="text-primary font-extrabold">el</span>,
        <span class="text-primary font-extrabold">värme</span> och
        <span class="text-primary font-extrabold">bredband.</span>
...
.gradient-cover {
  ...
  transition: color 0.5s, transform 0.5s, filter 0.5s ease-in-out;
}
.gradient-cover:hover {
